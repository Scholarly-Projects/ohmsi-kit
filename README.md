...
Future iterations of ohmsi-kit will include an editing workspace where users can open processed transcriptions locally to aid and streamline the copyediting process, leveraging Oral History as Data’s playback interface and Visual Studio Code’s user dictionary capabilities. Other advancements may include automated, tiered processing of audio files based on a programmatic survey that evaluates processed transcripts for accurate dialogue clustering.
